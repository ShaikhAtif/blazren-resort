    ...
    <div className="About">
      ...
      >
        <div className="header-content">
          ...
          <p>Learn about our resort</p>
        </div>

        <BookWidget />
      </header>
      <section className="desc">
        <h1 className="alt-font">Blazren Resort Phuket</h1>
        <span></span>
        <p>Get to know one of World's best resort</p>
      </section>
      <section className="desc_photo">
        <div className="descLeft">
          <h1 className="alt-font">Only Local Ingredients</h1>
          <p>
            we use only ingrdient that are grown here.
          </p>
        </div>
      ...
      <section className="testimonials">
          ...
          <div className="quote-container">
            <p>
              <em>
                ...
                to try the Blazren Resort. We were totally refreshed and
        ...
        <article className="testimonials-card reversed">
          ...
          <div className="quote-container">
            <p>
              <em>
                "We had been guests at the Blazren Resort last weekend and we have
